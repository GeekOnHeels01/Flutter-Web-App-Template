define(['dart_sdk', 'packages/the_basics/main'], function(dart_sdk, packages__the_basics__main) {
  'use strict';
  ...
  const main = packages__the_basics__main.main;
  ...
  dart.trackLibraries("packages/the_basics/main_web_entrypoint", {
    "package:the_basics/main_web_entrypoint.dart": main_web_entrypoint
  }, {
